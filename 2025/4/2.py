...
def remove_rolls(rolls, cells):
    ...
    for roll in rolls:
        ...
        if count <= 4:
            ...
            remaining_rolls.append(roll)
            remaining_cells[roll] = "@"
    
    return remaining_rolls, remaining_cells, answer
...
def main(puzzle_input: str):
    ...
    rolls, cells, a = remove_rolls(rolls, cells)
    answer += a
    while a != 0:
        rolls, cells, a = remove_rolls(rolls, cells)
        answer += a
